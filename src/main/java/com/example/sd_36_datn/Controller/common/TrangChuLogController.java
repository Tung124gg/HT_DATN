...
import com.example.sd_36_datn.Service.MailService;
   ...
   //Todo code thông tin tài khoản bên Admin
    ...
    public String saveAdminQuenMatKhau(
        ...
        try{
            ...
            if(khachHang != null){
                mailService.sendEmail(email, "Quên mật khẩu","Mật khẩu mới của bạn là: "+randomNumber, false, true);
                khachHang.setMatKhau(String.valueOf(randomNumber));
                khachHangRepository.save(khachHang);
            }
            else{
                System.out.println("Email không tồn tại!");
                model.addAttribute("loiEmailNull","Không tìm thấy địa chỉ email này!");
                return "templates/Admin/Layouts/DangNhap/quenMatKhau";
            }
