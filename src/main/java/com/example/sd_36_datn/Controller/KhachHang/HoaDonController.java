...
@Controller(value = "khachHangHoaDonController")
...
//    private GioHangRepository gioHangRepository;
    ...
    public String donHangCuaToi(Model model, Principal principal){
        KhachHang khachHang = khachHangRepository.findByEmail(principal.getName());
        List<HoaDon> hoaDons = hoaDonRepository.findByKhachHang(khachHang.getId());
        model.addAttribute("listHoaDon", hoaDons);
        return "HoaDon/donhangcuatoi";
    }
...
//                model.addAttribute("khachHangView",hoaDonChiTiet.getHoaDon().getKhachHang().getTenKhachHang());
        ...
        model.addAttribute("hoaDonChiTiets", hoaDonChiTiets);
        List<TrangThaiDonHang> trangThaiDonHangs = trangThaiDonHangRepository.findByDonHang(selectedIdHoaDonConvert);
        model.addAttribute("listtrangthai", trangThaiDonHangs);
        model.addAttribute("hoadonmd", hoaDonRepository.findById(selectedIdHoaDonConvert).get());
