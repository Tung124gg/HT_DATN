...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form action="/spring-security-login"
                ...
                <div class="text-center p-t-12">
                    ...
                    <a class="txt2" href="/dang-ky-tai-khoan">
                        <u style="font-size: 15px ; color: black">Đăng ký tài khoản</u>
                    </a>
...
<script>
    ...
    if(err != null){
        toastr.error("Tên đăg nhập hoặc mật khẩu không đúng");
    }
    if (performance.navigation.type == performance.navigation.TYPE_RELOAD) {
        window.location.href = '/UserLog/login'
    }
</script>
