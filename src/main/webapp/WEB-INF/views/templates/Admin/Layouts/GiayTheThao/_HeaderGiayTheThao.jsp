...
<%--                    <h6 class="collapse-header" style="color: black; font-size: 13px;">Pages</h6>--%>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#colbh"
               aria-expanded="true" aria-controls="colbh">
                <i class="fas fa-fw fa-wrench"></i>
                <span>Bán hàng</span>
            </a>
            <div id="colbh" class="collapse" aria-labelledby="headingUtilities"
                 data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="/BanHangTaiQuay">Tại quầy</a>
                    <a class="collapse-item" href="/BanHangTaiQuay/Admin/xacNhanDonHangKhachHangAll">Đơn hàng</a>
                </div>
            </div>
        </li>
    </ul>
