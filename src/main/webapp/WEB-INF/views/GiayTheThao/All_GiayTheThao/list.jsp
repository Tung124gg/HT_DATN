...
<head>
    ...
    <style>
        ...
        .bg-active {
            background: linear-gradient(135deg, #f7f7f7, #e0e0e0); /* Gradient nhẹ */
            padding: 20px;
            width: 140px;
            position: absolute;
            left: 0;
            ...
            transition: all 0.4s ease-in-out; /* Hiệu ứng chuyển động */
        }
...
<%--                                &lt;%&ndash;                                <input style="width: 500px;height: 35px; border-radius: 5px 5px 5px" type="text" id="thuongHieu" placeholder="Thương hiệu">&ndash;%&gt;--%>
...
<%--                <div class="bg-active"></div>--%>
            ...
            <div class="content-tabs">
                ...
                <div class="tab ${param.tab == 'inactive' ? 'active' : ''}" id="tab2">
                    ...
                    <h4 style="color: black">Chưa kích hoạt</h4>
                    <table style="border-collapse: collapse; width:100%; margin-top: 40px">
                        <thead>
                        <tr>
