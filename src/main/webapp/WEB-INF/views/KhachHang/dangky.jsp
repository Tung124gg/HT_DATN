        ...
        <div class="wrap-login100">
            ...
            <frm:form modelAttribute="khachhang"
                ...
                <div class="wrap-input100 validate-input">
                    <frm:input path="tenKhachHang" class="input100" type="text" name="fullname" placeholder="Họ tên"
                ...
                <div class="wrap-input100 validate-input" data-validate="....@email.com">
                    <frm:input path="email" class="input100" type="text" name="username" placeholder="Email"
                           style="font-weight: bold; font-size: 15px"/>
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
...
<%--                <div class="wrap-input100 validate-input" data-validate="....@email.com">--%>
<%--                    <frm:input path="email" class="input100" type="text" name="sdt" placeholder="Email"--%>
<%--                               style="font-weight: bold; font-size: 15px"/>--%>
<%--                    <span class="focus-input100"></span>--%>
<%--                    <span class="symbol-input100">--%>
<%--							<i class="fa fa-envelope" aria-hidden="true"></i>--%>
...
<%--                </div>--%>
                ...
                <div class="wrap-input100 validate-input" data-validate="Input type number or String">
                    <frm:input path="matKhau" class="input100" type="password" name="password" placeholder="Password"
                           style="font-weight: bold; font-size: 15px"/>
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="text-center p-t-12">
                    ...
                    <a class="txt2" href="/UserLog/login">
                        <u style="font-size: 15px ; color: black">Đăng nhập</u>
                    </a>
